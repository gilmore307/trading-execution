...
_HISTORICAL_FEATURE_PARITY_REFS = {
    ...
    "layer_08_event_risk_governor": "trading-data://src/data_feature/feature_08_event_risk_governor",  # current feature path
    "layer_04_alpha_confidence": "trading-model://src/models/model_04_alpha_confidence/generator.py",  # current model path
    "layer_05_position_projection": "trading-model://src/models/model_05_position_projection/generator.py",  # current model path
    "layer_06_underlying_action": "trading-model://src/models/model_06_underlying_action/generator.py",  # current model path
    "layer_07_option_expression": "trading-data://src/data_feature/feature_07_option_expression",  # current feature path
}
