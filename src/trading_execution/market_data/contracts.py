...
def realtime_input_coverage_matrix() -> tuple[RealtimeModelInputCoverage, ...]:
    ...
    return (
        ...
        RealtimeModelInputCoverage(
            ...
            validation_role=validation_role,
            boundary_note="Conceptual Layer 6 position projection cannot be complete until broker/account state contracts exist; market-data pieces remain separate from order mutation.",
        ),
        RealtimeModelInputCoverage(
            contract_type="execution_realtime_input_coverage",
            ...
            validation_role=validation_role,
            boundary_note="Conceptual Layer 7 feasibility needs current market data plus execution/account restrictions; it still emits a plan, not an order.",
        ),
        RealtimeModelInputCoverage(
            contract_type="execution_realtime_input_coverage",
            ...
            validation_role=validation_role,
            boundary_note="Conceptual Layer 8 realtime coverage centers on ThetaData option-chain/quote/trade context plus current underlying observations.",
        ),
        RealtimeModelInputCoverage(
            contract_type="execution_realtime_input_coverage",
