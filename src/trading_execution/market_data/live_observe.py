...
_PROVIDER_INTERFACE_HINTS = {
    ...
    "realtime_calendar_context": (
        ...
        "realtime_calendar_context.option_expiry_witching_rebalance_ref",
        "realtime_calendar_context.trading_economics_macro_release_ref",
        "realtime_calendar_context.company_release_context_ref",
    ),
    "calendar_discovery": (
    ...
    "derived_model_context": (
        "derived_model_context.current_model_state_ref",
...
_SOURCE_ASSET_CLASS = {
    ...
    "thetadata": "us_option",
    "okx": "crypto_spot",
    "realtime_calendar_context": "calendar_context_ref",
