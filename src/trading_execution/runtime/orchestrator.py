...
def build_realtime_trading_runtime_status(
    *,
    ...
    model_decision_input_snapshot_ref: str | None = None,
    trade_risk_cap_validation_ref: str | None = None,
    order_construction_approval_ref: str | None = None,
    ...
    return {
        ...
        "interfaces_connected": {
            ...
            "model_decision_input_snapshot": bool(model_decision_input_snapshot_ref),
        ...
        "runtime_refs": {
            ...
            "model_decision_input_snapshot_ref": model_decision_input_snapshot_ref,
            "trade_risk_cap_validation_ref": trade_risk_cap_validation_ref,
            "order_construction_approval_ref": order_construction_approval_ref,
        },
        "allowed_actions": {
