...
`execution_shadow_runtime_component` is the C08 intraday Shadow component. It is
not used by Replay.
...
C08 must be hardware-capacity gated. The runtime may run only as many model
