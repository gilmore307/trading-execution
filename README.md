...
- `docs/05_execution_acceptance.md` records the prior execution-preparation closeout; `docs/06_realtime_data.md` and `docs/07_broker_interfaces.md` open the next execution design slice without enabling broker adapters, order construction, order placement, fills, positions, or account mutation.
