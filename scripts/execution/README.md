...
- `simulate_c08_capacity.py` estimates how many realtime model groups C08 can run without degrading C01-C06 latency, market-data ingestion, broker gates, or account-state freshness. It performs no provider calls, model activation, broker calls, or account mutation.
