...
- `aggregate_realtime_decision_effectiveness.py` aggregates matured realtime/shadow decision records into `realtime_model_decision_effectiveness_v1` without creating historical dataset rows, activating models, persisting state, or mutating broker/account state.
