...
- `test_execution_capabilities.py` covers the side-effect-free realtime data and broker capability catalogs, including OKX enabled-for-scaffold/no-mutation posture, Alpaca paper-trading posture, and Firstrade deferred posture.
