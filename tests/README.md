...
- `test_execution_capabilities.py` covers the side-effect-free realtime data and broker capability catalogs, including OKX planning/no-mutation posture, Alpaca paper-trading posture, and Firstrade deferred posture.
- `test_realtime_market_data_scaffold.py` covers realtime subscription planning, concrete Alpaca/ThetaData/OKX/calendar/account/model-context live-observe fixture planning, live-observe blocking, execution-account context-ref routing, capture validation, realtime feature/model-decision input handoff validation, and CLI smoke checks.
