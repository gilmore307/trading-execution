...
- `test_realtime_market_data_scaffold.py` covers realtime subscription planning, live-observe blocking, execution-account placeholder routing, capture validation, realtime feature/model-decision input handoff validation, and CLI smoke checks.
