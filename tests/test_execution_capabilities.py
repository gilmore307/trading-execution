...
class ExecutionCapabilityCatalogTests(unittest.TestCase):
    ...
    def test_realtime_input_coverage_matrix_covers_all_model_layers(self) -> None:
        ...
        self.assertEqual(coverage["layer_04_alpha_confidence"].primary_realtime_sources, ("derived_model_context",))
        self.assertIn("execution_account_state", coverage["layer_05_position_projection"].primary_realtime_sources)
        self.assertIn("thetadata", coverage["layer_07_option_expression"].primary_realtime_sources)
        self.assertIn("option_chain_snapshot", coverage["layer_07_option_expression"].realtime_input_groups)
